...
python train.py \
  ...
  --eval-episodes 5 \
  --save-actions "${ACTION_DIR}/multi_seen_ppo_actions.json"
...
python train.py \
  ...
  --init-balance "${INIT_BALANCE}" \
  --eval-episodes 5 \
  --save-actions "${ACTION_DIR}/multi_mixed_ppo_actions.json"
...
python train.py \
  ...
  --init-balance "${INIT_BALANCE}" \
  --eval-episodes 5 \
  --save-actions "${ACTION_DIR}/multi_unseen_ppo_actions.json"
